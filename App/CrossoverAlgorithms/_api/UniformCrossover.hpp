...
class UniformCrossover : public CrossoverIndexBase<UniformCrossover>
{
public:
    UniformCrossover(const RandomCore &randomRef);
...
private:
    static constexpr CrossoverAlgoId algoId{CrossoverAlgoId::UNIFORM};

...
class BlendAlphaCrossover : public CrossoverIndexBase<BlendAlphaCrossover>
{
public:
    BlendAlphaCrossover(const RandomCore &randomRef);
...
private:
    static constexpr CrossoverAlgoId algoId{CrossoverAlgoId::BLEND_ALPHA};

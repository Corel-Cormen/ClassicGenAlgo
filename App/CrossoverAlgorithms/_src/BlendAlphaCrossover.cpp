...
BlendAlphaCrossover::BlendAlphaCrossover(const RandomCore &randomRef) :
    CrossoverIndexBase(),
    random{randomRef}
{}

bool BlendAlphaCrossover::crossover_impl(const UiData &uiData,
                                         ...
                                         GA::Types::GenomePoint &out2)
{
    ...
    for (size_t idx = 0U; idx < g1.point.size(); ++idx)
    {
        ...
        qreal max = CommonFunc::calcMaxElement(g1.point[idx].val(), g2.point[idx].val(), alpha);
